    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Baldwin & Co uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b61fdd0e-8376-45fc-ab5d-9b12c7e07ca6',
                    name: data.name || '',
                    email: data.email || '',
